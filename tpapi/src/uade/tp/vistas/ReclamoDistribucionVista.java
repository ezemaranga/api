...
public class ReclamoDistribucionVista extends javax.swing.JFrame{
	...
	private static ReclamoDistribucionVista instancia;
	...
	public static ReclamoDistribucionVista getInstancia(String nroReclamo) {
		if (nroReclamo != null) {
			instancia = new ReclamoDistribucionVista(nroReclamo);
		} else if (nroReclamo == null) {
			instancia = new ReclamoDistribucionVista();
		}
		return instancia;
	}
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				ReclamoDistribucionVista inst = new ReclamoDistribucionVista();
	...
	public ReclamoDistribucionVista() {
		super();
		reclamoView = new ReclamoView();
		initGUI();
	}

	public ReclamoDistribucionVista(String nroReclamo) {
		super();
			...
			}
			{
				...
				cancelar.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent evt) {
						ReclamoDistribucionVista.getInstancia(null).setVisible(false);
