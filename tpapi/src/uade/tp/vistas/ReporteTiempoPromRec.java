...
public class ReporteTiempoPromRec extends javax.swing.JFrame {
	...
	String[] columnNames = {"Responsable",
			                "Tiempo Respuesta",
							"Cant. Reclamos"};
	
	private static ReporteTiempoPromRec instancia;
	
	public static ReporteTiempoPromRec getInstancia()
	{
		if (instancia == null)
			instancia = new ReporteTiempoPromRec();
		return instancia;
	}
	...
	*/
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				ReporteTiempoPromRec inst = new ReporteTiempoPromRec();
	...
	private void initGUI() {
		try {
			...
			this.setTitle("Tiempo promedio de respuesta de Reclamos por Responsable");
			...
			
			{
				jLabel1 = new JLabel();
				jPanel.add(jLabel1);
				jLabel1.setText("Tiempo promedio de respuesta por Responsable");
