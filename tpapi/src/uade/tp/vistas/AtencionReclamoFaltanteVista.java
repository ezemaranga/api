...
public class AtencionReclamoFaltanteVista extends javax.swing.JFrame {
	...
	private static AtencionReclamoFaltanteVista instancia;
	
	public static AtencionReclamoFaltanteVista getInstancia()
	{
		if (instancia == null)
			instancia = new AtencionReclamoFaltanteVista();
		return instancia;
	}
	...
	*/
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				AtencionReclamoFaltanteVista inst = new AtencionReclamoFaltanteVista();
	...
	public AtencionReclamoFaltanteVista() {
		super();
		initGUI();
	}
	...
	private void initGUI() {
		try {
			...
			this.setTitle("Atencion de Reclamos - Reclamo por Faltante");
			...
			
			{
				jLabel1 = new JLabel();
				jPanel.add(jLabel1);
				jLabel1.setText("Atencion de Reclamos por Faltante");
			...
			
			{
				...
				cancelar.addActionListener(new ActionListener() {
					...
					{
						limpiarPantalla();
						AtencionReclamoFaltanteVista.getInstancia().setVisible(false);
					}
				});
			}
