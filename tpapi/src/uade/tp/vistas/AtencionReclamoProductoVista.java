...
public class AtencionReclamoProductoVista extends javax.swing.JFrame{
	...
	private static AtencionReclamoProductoVista instancia;
	
	public static AtencionReclamoProductoVista getInstancia()
	{
		if (instancia == null)
			instancia = new AtencionReclamoProductoVista();
		return instancia;
	}
	...
	*/
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				AtencionReclamoProductoVista inst = new AtencionReclamoProductoVista();
	...
	public AtencionReclamoProductoVista() {
		super();
		initGUI();
	}
	...
	private void initGUI() {
		try {
			...
			this.setTitle("Atencion de Reclamos - Reclamo de Productos");
			...
			
			{
				jLabel1 = new JLabel();
				jPanel.add(jLabel1);
				jLabel1.setText("Atencion de Reclamo Productos");
			...
			
			{
				...
				cancelar.addActionListener(new ActionListener() {
					...
					{
						limpiarPantalla();
						AtencionReclamoProductoVista.getInstancia().setVisible(false);
					}
				});
			}
